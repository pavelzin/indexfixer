...
class IndexFixer_Dashboard_Widget {
    ...
    public static function calculate_statistics() {
        // ZMIANA: Używaj tej samej metody co główny dashboard
        // Sprawdź czy mamy dane w tabeli bazy danych
        $db_stats = IndexFixer_Database::get_statistics();
        
        // Jeśli tabela ma dane, użyj ich
        if ($db_stats && $db_stats['total'] > 0) {
            return $db_stats;
        }
        
        // Fallback: użyj tej samej logiki co główny dashboard
