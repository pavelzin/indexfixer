...
if ($status_filter === 'URL is unknown to Google') {
    $where[] = '(coverage_state = "URL is unknown to Google")';
} elseif ($status_filter === 'unknown') {
    $where[] = '(verdict = "unknown" OR coverage_state = "unknown" OR verdict IS NULL OR coverage_state IS NULL)';
    ...
    <div class="indexfixer-filters">
        <form method="get" action="">
            ...
            <select name="status" id="status-filter">
                ...
                <option value="unknown" <?php selected($status_filter, 'unknown'); ?>>Nieznane (NULL/unknown)</option>
                <option value="URL is unknown to Google" <?php selected($status_filter, 'URL is unknown to Google'); ?>>URL is unknown to Google</option>
            </select>
